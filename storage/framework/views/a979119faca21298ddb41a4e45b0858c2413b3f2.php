          ...
          <tbody>
            <?php $__currentLoopData = $collection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                  <a href="javascript:void(0);" onclick="handle_open_modal('<?php echo e(route('office.books.edit',$book->id)); ?>','#bookModal','#contentBookModal');" class="btn btn-success btn-icon-split btn-sm">
...
<?php endif; ?><?php /**PATH D:\KULIAH\DICODING\laragon\www\perpustakaan-main\resources\views/pages/office/book/list.blade.php ENDPATH**/ ?>