...
<?php $component = $__env->getContainer()->make(App\View\Components\OfficeLayout::class, ['title' => 'Data Pengguna']); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div id="content_list">
        <div class="container-fluid">
            ...
            <p class="mb-4">Berikut merupakan data pengguna perpustakaan Lumban Dolok</p>

            <!-- DataTales Example -->
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Data Pengguna 2.0.1</h6>
              </div>
              <div class="card-body">
...
<?php endif; ?><?php /**PATH D:\KULIAH\DICODING\laragon\www\perpustakaan-main\resources\views/pages/office/member/main.blade.php ENDPATH**/ ?>