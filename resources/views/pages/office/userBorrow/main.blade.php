    ...
    <div id="content_list">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="{{ route('office.user-borrow.request_download_pdf')}}"class="btn btn-danger mb-3 btn-icon-split btn-sm" >
                        <span class="icon text-white-50">
                            <i class="fas fa-check"></i>
                        </span>
                        <span class="text">Cetak Data Peminjam (PDF)</span>
                    </a>
                    <a href="{{ route('office.user-borrow.request_download_excel')}}"class="btn btn-warning mb-3 btn-icon-split btn-sm" >
                        <span class="icon text-white-50">
                            <i class="fas fa-check"></i>
                        </span>
